...
class RPNTestMixin(object):
    ...
    def simple_test_rpn(self, x, img_metas):
        ...
        """
        rpn_outs = self(x)  #([score1,score2,score3],[pred1,pred2,pred3])    1xnums*2xhxw    1xnums*4xhxw
        proposal_list = self.get_bboxes(*rpn_outs, img_metas)  # result_list dict : (N, 4),(N, 5),(N, 5)
        return proposal_list
